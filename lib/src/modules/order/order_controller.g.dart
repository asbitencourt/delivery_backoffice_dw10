...
mixin _$OrderController on OrderControllerBase, Store {
  ...
  late final _$findOrdesAsyncAction =
      AsyncAction('OrderControllerBase.findOrdes', context: context);

  @override
  Future<void> findOrdes() {
    return _$findOrdesAsyncAction.run(() => super.findOrdes());
  }
