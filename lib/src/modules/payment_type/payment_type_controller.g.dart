...
mixin _$PaymentTypeController on PaymentTypeControllerBase, Store {
  ...
  late final _$loadingPaymentsAsyncAction = AsyncAction(
      'PaymentTypeControllerBase.loadingPayments',
      context: context);

  @override
  Future<void> loadingPayments() {
    return _$loadingPaymentsAsyncAction.run(() => super.loadingPayments());
  }
  ...
  void filterChanged(bool? enabled) {
    final _$actionInfo = _$PaymentTypeControllerBaseActionController
        .startAction(name: 'PaymentTypeControllerBase.filterChanged');
    try {
      return super.filterChanged(enabled);
    } finally {
